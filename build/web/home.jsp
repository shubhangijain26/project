...
<div class="navbar" style="height:80px;">
  ...
  <a href=" " style="margin-left:80px;font-family: Comic Sans MS;font-size:30px">Quikr</a>
  
 
<select style="width:40%;padding:10px">
...
<option> SECRETARY</option>
  ...
  <font  style="margin-left:50px;">Welcome <%=   
        request.getSession().getAttribute("nm").toString()
    %></font>
    
  <a href=" " style="margin-left:70px"> <i class='fas fa-shopping-cart' style='font-size:30px; padding:24px'></i>Cart </a>
...
<p>Semi-Auto Lubrication | Motorized </p> 
<h4> 35,000</h4>
</a>
